...
public class ShadowTimeManager {
  ...
  public void setTimeZoneCapabilityState(String capability, @CapabilityState int value) {
    ...
    switch (capability) {
      ...
      case SET_MANUAL_TIME_ZONE_CAPABILITY -> builder.setSetManualTimeZoneCapability(value);
      case SUGGEST_MANUAL_TIME_ZONE_CAPABILITY -> builder.setSuggestManualTimeZoneCapability(value);
      default ->
  ...
  public void setTimeCapabilityState(String capability, @CapabilityState int value) {
    ...
    switch (capability) {
      case CONFIGURE_TIME_AUTO_DETECTION_ENABLED_CAPABILITY ->
          builder.setConfigureAutoDetectionEnabledCapability(value);
      case SET_MANUAL_TIME_CAPABILITY -> builder.setSetManualTimeCapability(value);
      default -> throw new IllegalArgumentException("Unrecognized time capability=" + capability);
    }
